...
public class DaoFilme<E> {
	...
	public List<String> obterGeneros() {
		String jpql = "SELECT DISTINCT e.Id_genero FROM " + classe.getName() + " e";
	...
	public void updateFilme(Filme filme, String nome, String classificacao, String genero, String sinopse, String autor,
		...
		try {
			...
			em.getTransaction().rollback();
			showNotification("Erro", "A atualização do filme falhou devido a um erro inesperado.",
